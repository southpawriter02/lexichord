# LCS-DES-113-SEC-i: Data Masking

## Document Control

| Field            | Value                                                        |
| :--------------- | :----------------------------------------------------------- |
| **Document ID**  | LCS-DES-113-SEC-i                                            |
| **Version**      | v0.11.3                                                      |
    ...
    IMaskingRepository repository) : IDataMaskingService
{
            ...
            foreach (var propClass in maskedProperties)
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        var maskedValue = Mask(valueStr, propClass.MaskingType);
        ...
        CancellationToken ct = default)
    {
        try
        {
            ...
            var value = await repository.GetActualValueAsync(propertyId, ct);
...
public class DataMaskingServiceTests
{
    ...
    public async Task MaskEntityAsync_UnmaskedWhenPermitted()
    {
        ...
        var classifications = new[] {
            new PropertyClassification { PropertyName = "Email", RequiresMasking = true, MaskingType = MaskingType.Email }
        };
        ...
        // Act
        var result = await _sut.MaskEntityAsync(entity, new MaskingContext { AllowUnmasking = true });
