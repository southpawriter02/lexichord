# LCS-DES-111-SEC-i: Design Specification — Permission Inheritance

## 1. Metadata & Categorization

| Field | Value | Description |
| :--- | :--- | :--- |
| **Feature ID** | `SEC-111-i` | Access Control sub-part i |
| **Feature Name** | `Permission Inheritance` | Inherit permissions through graph relationships |
| **Target Version** | `v0.11.1i` | Ninth sub-part of v0.11.1-SEC |
...
| **Scope Breakdown** | [LCS-SBD-111-SEC S2.1](./LCS-SBD-111-SEC.md#21-sub-parts) | i = Permission Inheritance |
...
| :--- | :--- | :--- |
| Permission model | v0.11.1e | Permission, Role definitions |
| Entity ACLs | v0.11.1g | Parent entity ACLs |
| Graph relationships | v0.4.5e | Parent-child relationships |
| ACL Evaluator | v0.11.1g | Evaluate ACL permissions |
