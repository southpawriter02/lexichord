# LCS-DES-111-SEC-j: Design Specification — Access Control UI

## 1. Metadata & Categorization

| Field | Value | Description |
| :--- | :--- | :--- |
| **Feature ID** | `SEC-111-j` | Access Control sub-part j |
| **Feature Name** | `Access Control UI` | Administrative interface for permissions |
| **Target Version** | `v0.11.1j` | Tenth sub-part of v0.11.1-SEC |
...
| **Scope Breakdown** | [LCS-SBD-111-SEC S2.1](./LCS-SBD-111-SEC.md#21-sub-parts) | j = Access Control UI |
...
| :--- | :--- | :--- |
| IAuthorizationService | v0.11.1f | Check UI permissions |
| IRoleService | v0.11.1h | Role management |
| IAclEvaluator | v0.11.1g | ACL evaluation |
| IInheritanceEvaluator | v0.11.1i | Inheritance visualization |
