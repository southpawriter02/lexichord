# LCS-DES-114-SEC-i: Design Specification — Input Normalizer

## 1. Metadata & Categorization

| Field                | Value                                      |
| :------------------- | :----------------------------------------- |
| **Document ID**      | LCS-DES-114-SEC-i                          |
| **Feature ID**       | SEC-114i                                   |
...
///     "  Hello  WORLD  ",
///     new NormalizationOptions { TrimWhitespace = true });
/// // Result: "Hello WORLD" (no case change by default)
///
/// // Sanitize HTML
/// var safe = _normalizer.SanitizeHtml(userHtml, new HtmlSanitizationOptions());
///
/// // Validate URL
    ...
    public UrlValidationResult Validate(string url)
    {
        ...
        try
        {
            ...
            return new UrlValidationResult
            {
                ...
                IsSecure = uri.Scheme == "https" || uri.Scheme == "ftps"
            };
        }
        catch (Exception ex)
        {
...
public class InputNormalizerTests
{
    ...
    {
        var result = _sut.NormalizeString(input, new NormalizationOptions { TrimWhitespace = true });
    ...
    public void NormalizeString_CollapseWhitespace_ReducesSpaces()
    {
        var result = _sut.NormalizeString(
            "hello    world",
            new NormalizationOptions { CollapseWhitespace = true });
    ...
    public void NormalizeString_ToLowercase_ConvertsCase()
    {
        var result = _sut.NormalizeString(
            "Hello WORLD",
            new NormalizationOptions { ToLowercase = true });
    ...
    public void NormalizeString_MaxLength_Truncates()
    {
        var result = _sut.NormalizeString(
            "hello world",
            new NormalizationOptions { MaxLength = 5 });
    ...
    public void NormalizeString_NormalizeUnicode_ComposesAccents()
    {
        ...
        var result = _sut.NormalizeString(
            input,
            new NormalizationOptions { NormalizeUnicode = true });
