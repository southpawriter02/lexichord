# LCS-DES-112-SEC-j: Design Specification — Audit Query UI

## 1. Metadata & Categorization

| Field                | Value                                      |
| :------------------- | :----------------------------------------- |
| **Document ID**      | LCS-DES-112-SEC-j                          |
| **Feature ID**       | SEC-112j                                   |
...
<div class="query-builder">
    ...
    <div class="filter-group">
        ...
        <div class="radio-group">
            <label><input type="radio" @onchange="e => FilterOutcome = null"
                @checked="FilterOutcome == null" /> All</label>
            <label><input type="radio" @onchange="e => FilterOutcome = AuditOutcome.Success"
                @checked="FilterOutcome == AuditOutcome.Success" /> Success</label>
            <label><input type="radio" @onchange="e => FilterOutcome = AuditOutcome.Failure"
