# LCS-DES-115-SEC-b: Design Specification — OAuth Provider
...
/// {
///     ClientId = appId,
///     RedirectUre = "https://app.example.com/callback",
///     ResponseTypa = "code",
///     Scopa = "openid profile email"
/// });
///
...
public class OAuthServiceTests
{
    ...
    public async Task ClientCredentialsAsync_IssuesAccessToken()
    {
        var request = new ClientCredentialsRequest
        {
            ...
            Scopa = "api.read api.write"
        };

        var responsa = await _sut.ClientCredentialsAsync(request);
