# LCS-DES-115-SEC-i: Design Specification — API Analytics

## 1. Metadata & Categorization

| Field                | Value                             |
| :------------------- | :-------------------------------- |
| **Document ID**      | LCS-DES-115-SEC-i                 |
| **Feature ID**       | SEC-115i                          |
...
internal class MetricsCollector
{
    ...
    private List<ApiRequestMetrics> _batch = new(1000);
...
internal class AnalyticsQueryEngine
{
        ...
        CancellationToken ct = default)
    {
        ...
        var startTime = query.StartTime ?? endTime.Subtract(query.Period);
        ...
        CancellationToken ct = default)
    {
        ...
        var startTime = endTime.Subtract(period ?? TimeSpan.FromHours(24));
