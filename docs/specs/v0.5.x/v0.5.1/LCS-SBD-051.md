...
| #   | Deliverable                                            | Status |
| :-- | :----------------------------------------------------- | :----- |
| 1   | `Migration_004_FullTextSearch.cs` with tsvector column | [ ]    |
| 2   | `IBM25SearchService` interface in Abstractions         | [ ]    |
| 3   | `BM25Hit` record                                       | [ ]    |
| 4   | `BM25SearchService` implementation                     | [ ]    |
...
| 13  | Unit tests for BM25SearchService                       | [ ]    |
