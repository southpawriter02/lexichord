...
| DocumentChangedEvent | v0.1.3 | Trigger for linting pipeline |
| IMediator / Event Bus | v0.0.7 | Publish LintingCompletedEvent |
| IConfigurationService | v0.0.3d | Linter settings (debounce, scope) |
...
- v0.0.3d: IConfigurationService (persist settings)
